          ...
          >
            <div className="flex items-start justify-between gap-3 border-b border-[var(--theme-divider)] px-5 py-5">
              <div className="min-w-0">
                <div className="flex items-center gap-2 text-[11px] font-bold text-[var(--theme-brand-text)]">
            ...
            <div className="min-h-0 flex-1 space-y-4 overflow-y-auto p-5">
              ...
              <label className="block" htmlFor="dashboard-ai-assistant-input">
                ...
                <textarea
                  ...
                  className="min-h-36 w-full resize-none rounded-[4px] border border-[var(--theme-border)] bg-[var(--theme-input)] px-4 py-3 text-sm font-medium leading-6 text-[var(--theme-text-primary)] outline-none transition placeholder:text-[var(--theme-text-muted)] focus:border-[var(--theme-brand-border)] focus:ring-4 focus:ring-[var(--theme-brand-subtle)]"
                />
              </label>
            </div>
