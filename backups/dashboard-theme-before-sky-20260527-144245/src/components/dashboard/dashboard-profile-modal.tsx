      ...
      <DialogContent className="sm:max-w-lg" showCloseButton={!closeDisabled}>
        <DialogHeader>
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[var(--theme-surface-overlay)]">
              <UserRound className="h-5 w-5 text-[var(--theme-text-secondary)]" />
            </div>
            <div>
