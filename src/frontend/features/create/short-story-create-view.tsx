    ...
    <main className="create-modern-shell min-h-dvh w-full overflow-x-clip bg-[#f7f8fa] text-slate-900">
      ...
      <div className="relative mx-auto flex min-h-dvh w-full max-w-[1480px] flex-col">
        <header className="sticky top-0 z-50 border-b border-slate-200/60 bg-white/92 backdrop-blur-xl">
          <div className="grid min-h-[64px] grid-cols-[minmax(0,1fr)_auto] items-center gap-3 px-3.5 py-2 sm:px-4 lg:px-[18px]">
        ...
        <div className="flex-1 px-3.5 pb-16 pt-3.5 sm:px-4 lg:px-[18px]">
          ...
          <form
            ...
            noValidate
            className="grid gap-3 min-[1080px]:grid-cols-[280px_minmax(0,1fr)_300px] min-[1080px]:items-start"
          >
            <aside className="rounded-2xl border border-slate-200/80 bg-white/92 p-4 shadow-[0_16px_34px_-28px_rgba(15,23,42,0.28)]">
              ...
              <div className="mt-4 space-y-2">
                {["不分卷", "按场景写作", "复用作品和章节页"].map((item) => (
                  <div
                    key={item}
                    className="flex items-center gap-2 rounded-xl border border-slate-200/70 bg-slate-50/80 px-3 py-2 text-xs font-bold text-slate-600"
                  >
            ...
            <section className="min-w-0 rounded-2xl border border-slate-200/80 bg-white/95 p-4 shadow-[0_18px_42px_-34px_rgba(15,23,42,0.32)] sm:p-5">
              <div className="mb-4 flex flex-wrap items-start justify-between gap-3 border-b border-slate-100 pb-4">
                ...
                <div className="inline-flex items-center rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-xs font-bold text-slate-500">
              ...
              <div className="grid gap-4">
                <div>
                    ...
                    {GENRE_PRESETS.map((item) => (
                      <button
                        ...
                        className={cn(
                          ...
                          create.genre === item
                            ? "border-slate-950 bg-slate-950 text-white shadow-[0_14px_26px_-20px_rgba(15,23,42,0.9)]"
                  ...
                  <input
                    ...
                    className="mt-2 h-11 w-full rounded-xl border border-slate-200 bg-slate-50/80 px-3 text-sm font-bold text-slate-900 outline-none transition-all duration-200 placeholder:text-slate-400 focus:border-slate-400 focus:bg-white focus:ring-4 focus:ring-slate-900/5"
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <div>
                    ...
                    <input
                      ...
                      className="h-11 w-full rounded-xl border border-slate-200 bg-slate-50/80 px-3 text-sm font-bold text-slate-900 outline-none transition-all duration-200 placeholder:text-slate-400 focus:border-slate-400 focus:bg-white focus:ring-4 focus:ring-slate-900/5"
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-[minmax(0,1fr)_112px] gap-2">
                      <select
                        ...
                        className="h-11 rounded-xl border border-slate-200 bg-slate-50/80 px-3 text-sm font-bold text-slate-900 outline-none transition-all duration-200 focus:border-slate-400 focus:bg-white focus:ring-4 focus:ring-slate-900/5"
                      >
                      ...
                      <input
                        ...
                        className="h-11 rounded-xl border border-slate-200 bg-slate-50/80 px-3 text-sm font-bold tabular-nums text-slate-900 outline-none transition-all duration-200 placeholder:text-slate-400 focus:border-slate-400 focus:bg-white focus:ring-4 focus:ring-slate-900/5 disabled:opacity-45"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="min-h-[178px] w-full resize-y rounded-2xl border border-slate-200 bg-slate-50/80 px-4 py-3 text-[15px] font-semibold leading-7 text-slate-900 outline-none transition-all duration-200 placeholder:text-slate-400 focus:border-slate-400 focus:bg-white focus:ring-4 focus:ring-slate-900/5"
            ...
            <aside className="rounded-2xl border border-slate-200/80 bg-white/95 p-4 shadow-[0_18px_42px_-34px_rgba(15,23,42,0.32)] min-[1080px]:sticky min-[1080px]:top-[78px]">
              <div className="flex items-center gap-3">
              ...
              <div className="mt-4 space-y-2 rounded-2xl border border-slate-200 bg-slate-50/80 p-3 text-xs font-bold text-slate-600">
              ...
              <button
                ...
                className="mt-4 inline-flex h-11 w-full items-center justify-center gap-2 rounded-2xl bg-[linear-gradient(135deg,#111827,#334155)] px-4 text-sm font-extrabold text-white shadow-[0_18px_34px_-22px_rgba(15,23,42,0.95)] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_22px_38px_-22px_rgba(15,23,42,0.9)] active:scale-[0.98] disabled:cursor-wait disabled:opacity-65"
              >
...
function FieldError({ message }: { message?: string }) {
  ...
  return <p className="mt-1.5 text-xs font-bold text-red-500">{message}</p>;
}
