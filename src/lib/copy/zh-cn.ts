export const zhCN = {
  ...
  auth: {
    ...
    error: {
      ...
      loginTooFrequent: "尝试次数过多，请稍后再试。",
      accountUnavailable: "账号不可用，请联系管理员。",
      mailSendFailed: "邮件发送失败，请稍后再试。",
      codeMissing: "验证码不存在或已失效，请重新获取。",
      codeUnavailable: "验证码无效，请重新获取。",
      codeUsed: "验证码已使用，请重新获取。",
      codeExpired: "验证码已过期，请重新发送。",
      codeIncorrect: "验证码不正确。",
      codeTooManyFailures: "验证码错误次数过多，请重新获取。",
      codeSendTooFrequent: "验证码发送过于频繁，请稍后再试。",
