  ...
  return (
    <section className="overflow-hidden rounded-lg border border-stone-200 bg-white/82 shadow-sm backdrop-blur dark:border-white/10 dark:bg-white/[0.04]">
      <div className="flex items-center justify-between gap-3 border-b border-stone-100 px-3 py-2.5 dark:border-white/10">
        <div>
          <h2 className="text-sm font-bold text-stone-950 dark:text-stone-50">逻辑路线状态</h2>
        ...
        <span className="rounded-md border border-stone-200 bg-stone-50 px-2 py-1 text-[11px] font-semibold text-stone-500 dark:border-white/10 dark:bg-white/[0.04] dark:text-stone-400">
        ...
        {providers.map((provider) => (
          <article key={provider.id} className="px-3 py-3">
            <div className="flex items-center justify-between gap-2">
              <div className="min-w-0">
                <div className="flex items-center gap-2">
                  <h3 className="truncate text-sm font-bold text-stone-950 dark:text-stone-50">
                    {provider.label}
                  </h3>
                  <span className="rounded-md border border-stone-200 bg-stone-50 px-1.5 py-0.5 text-[10px] font-semibold text-stone-500 dark:border-white/10 dark:bg-white/[0.04] dark:text-stone-400">
                    逻辑路由
                  </span>
                </div>
            ...
            <div className="mt-2 rounded-md border border-stone-200 bg-stone-50 px-2.5 py-2 dark:border-white/10 dark:bg-white/[0.04]">
              ...
              <p className="mt-1 truncate font-mono text-xs font-bold text-stone-800 dark:text-stone-100">
...
export function PhysicalProviderPanel({ providers }: { providers: PhysicalProviderOption[] }) {
  return (
    <section className="overflow-hidden rounded-lg border border-stone-200 bg-white/82 shadow-sm backdrop-blur dark:border-white/10 dark:bg-white/[0.04]">
      <div className="flex items-center justify-between gap-3 border-b border-stone-100 px-3 py-2.5 dark:border-white/10">
        <div>
          <h2 className="text-sm font-bold text-stone-950 dark:text-stone-50">物理端点面板</h2>
          <p className="mt-0.5 text-[11px] font-bold text-stone-500 dark:text-stone-400">
  ...
  return (
    <section className="overflow-hidden rounded-lg border border-stone-200 bg-white/76 shadow-sm backdrop-blur dark:border-white/10 dark:bg-white/[0.04]">
      <div className="border-b border-stone-100 px-3 py-2.5 dark:border-white/10">
        <h2 className="text-sm font-bold text-stone-950 dark:text-stone-50">环境变量参考</h2>
      </div>
      <div className="divide-y divide-stone-100 dark:divide-white/10">
        {providers.map((provider) => (
          <div key={provider.id} className="grid gap-1 px-3 py-2.5 text-xs">
            ...
            <p className="truncate font-mono text-[11px] font-semibold text-stone-400 dark:text-stone-500">
              {provider.baseUrl}
            </p>
          </div>
        ))}
        <div className="px-3 py-2.5">
          <p className="text-[11px] font-semibold leading-5 text-stone-500 dark:text-stone-400">
