      ...
      <div className="overflow-x-auto">
        <table className="w-full min-w-[1220px] table-fixed text-left text-sm">
          ...
          <thead className="border-b border-[#e7eef8] bg-[#fbfdff] text-[12px] font-black text-[#536889]">
            <tr>
              <th className="whitespace-nowrap px-3 py-3">编号</th>
              <th className="whitespace-nowrap px-3 py-3">邮箱 / 昵称</th>
              <th className="whitespace-nowrap px-3 py-3">角色</th>
              <th className="whitespace-nowrap px-3 py-3">会员</th>
              <th className="whitespace-nowrap px-3 py-3">状态</th>
              <th className="whitespace-nowrap px-3 py-3">验证</th>
              <th className="whitespace-nowrap px-3 py-3">最近登录</th>
              <th className="whitespace-nowrap px-3 py-3">创建时间</th>
              <th className="whitespace-nowrap px-3 py-3">统计</th>
...
function UserRow({
  ...
  return (
    <tr className="border-b border-[#e7eef8] align-middle last:border-0 hover:bg-[#fbfdff]">
      <td className="whitespace-nowrap px-3 py-3 text-[15px] font-black text-[#14213d]">#{user.code}</td>
      ...
      <td className="whitespace-nowrap px-3 py-3 text-sm font-bold text-[#536889]">
        {user.emailVerified ? "已验证" : "未验证"}
      </td>
      <td className="px-3 py-3 text-sm font-bold text-[#536889]">
      ...
      <td className="px-3 py-3 text-right">
        <div className="flex justify-end gap-1.5">
          <Button type="button" variant="outline" size="sm" onClick={onDetail} className="h-8 rounded-none border-[#d9e6f5] bg-white px-2 text-xs font-black text-[#14213d] hover:bg-[#f7fbff]">
            <Eye className="h-4 w-4" />
            详情
          </Button>
          <Button type="button" variant="outline" size="sm" onClick={onEdit} className="h-8 rounded-none border-[#d9e6f5] bg-white px-2 text-xs font-black text-[#14213d] hover:bg-[#f7fbff]">
