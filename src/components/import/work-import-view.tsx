        ...
        <div className="grid min-h-0 flex-1 grid-cols-1 gap-4 xl:grid-cols-[320px_minmax(0,1fr)_360px]">
          <section className="rounded-lg border border-[var(--theme-border)] bg-[var(--theme-surface-soft)] p-4 shadow-sm">
            <div className="mb-4 flex items-center gap-3">
              <span className="flex h-10 w-10 items-center justify-center rounded-lg bg-[var(--theme-text-strong)] text-[var(--theme-bg)]">
            ...
            <div className="space-y-4">
              ...
              <Field label="简介（可选）">
                <textarea
                  ...
                  className="w-full resize-y rounded-lg border border-[var(--theme-border)] bg-[var(--theme-surface-solid)] px-3 py-2.5 text-sm leading-6 text-[var(--theme-text-primary)] outline-none transition focus:ring-2 focus:ring-[var(--theme-brand-500)]/15"
                />
              </Field>
            </div>
          </section>
          ...
          <section className="flex min-h-[34rem] flex-col rounded-lg border border-[var(--theme-border)] bg-[var(--theme-surface-soft)] shadow-sm">
            ...
            {fileName ? (
              <div className="mx-4 mt-3 inline-flex w-fit items-center gap-2 rounded-lg bg-[var(--theme-brand-soft)] px-3 py-1.5 text-xs font-bold text-[var(--theme-brand-text)] ring-1 ring-[var(--theme-brand-border)]">
            ...
            <div className="min-h-0 flex-1 p-4">
              <textarea
                ...
                placeholder={"粘贴作品全文...\n\n第1章 初遇\n正文内容...\n\n第二章 转折\n正文内容..."}
                className="h-full min-h-[30rem] w-full resize-y rounded-lg border border-[var(--theme-border)] bg-[var(--theme-surface-solid)] px-4 py-3 text-sm leading-7 text-[var(--theme-text-primary)] shadow-inner outline-none transition placeholder:text-[var(--theme-text-muted)] focus:ring-2 focus:ring-[var(--theme-brand-500)]/15"
              />
            </div>
  ...
  return (
    <Field label={label}>
      <input
        ...
        className="h-10 w-full rounded-lg border border-[var(--theme-border)] bg-[var(--theme-surface-solid)] px-3 text-sm font-semibold text-[var(--theme-text-primary)] outline-none transition placeholder:text-[var(--theme-text-muted)] focus:ring-2 focus:ring-[var(--theme-brand-500)]/15"
      />
    </Field>
  );
}
