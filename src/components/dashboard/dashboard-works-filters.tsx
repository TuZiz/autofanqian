      ...
      <div className="flex flex-col gap-2 lg:flex-row lg:items-center lg:justify-between">
        <div className="flex min-w-0 flex-col gap-2 sm:flex-row sm:items-center">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <StatusBadge className={loading ? "" : "hidden"} tone={loading ? "ai" : "neutral"}>
              {loading ? (
                <>
        ...
        >
          <FieldShell
            ...
            className="h-9 w-full rounded-[4px] lg:w-[360px] 2xl:w-[420px]"
          />
        </form>
      </div>

      {filters.q.trim() || filters.genreId.trim() || filters.tag.trim() ? (
        <div className="flex flex-wrap items-center gap-1.5 text-xs font-medium text-[var(--theme-text-muted)]">
