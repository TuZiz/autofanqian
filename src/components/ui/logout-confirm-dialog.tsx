      ...
      >
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0">
            <h3 id="logout-confirm-title" className="text-lg font-black text-[var(--theme-text-strong)]">
              确认退出账号？
            </h3>
            <p
              id="logout-confirm-description"
              className="mt-1 text-sm leading-relaxed text-[var(--theme-text-secondary)]"
            >
