      ...
      <div className="flex items-start justify-between gap-4 border-b border-[var(--theme-border)] bg-[var(--theme-surface-soft)] px-6 py-5">
        <div className="flex min-w-0 items-start gap-4">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-2 text-sm font-medium leading-relaxed text-[var(--theme-text-muted)]">
      ...
      <div className="space-y-3 px-6 py-6">
        ...
        <div className="flex items-start justify-between gap-4 text-xs font-bold">
          <div className="min-w-0 space-y-2">
            {existingText ? (
              <p className="text-[var(--theme-warning-text)]">
                当前已有内容，生成后会覆盖。
              </p>
            ) : null}
            {disabledReason ? (
              <p className="text-[var(--theme-warning-text)]">{disabledReason}</p>
            ) : null}
          </div>
